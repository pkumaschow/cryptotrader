...
📖 **[Documentation](https://pkumaschow.github.io/cryptotrader/)** — operator manual and API
reference. Start with [Configuration](https://pkumaschow.github.io/cryptotrader/configuration.html)
if you are about to run this in production: it covers what each setting costs you when it is wrong.
...
```bash
curl http://your-pi-host:8080/health          # inspect health directly
```
